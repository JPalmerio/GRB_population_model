...
! Usage:  call mtsavef( file_name, format_character )
!    or   call mtsaveu( unit_number, format_character )
...
! Usage:  call mtgetf( file_name, format_character )
!    or   call mtgetu( unit_number, format_character )
